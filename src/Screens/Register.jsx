  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      gender: Yup.string()
        ...
        .oneOf(["male", "female", "other"], "Invalid type"),
      age: Yup.number()
    ...
    <div className="flex items-center justify-center bg-gray-100 h-[90vh] lg:h-screen">
      <div className="flex flex-col items-center w-full h-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg lg:h-fit ">
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#14b8a6] via-[#ea580c] to-[#dc2626]">
            Create an Account
          </h2>
        </div>
        ...
        {/* Form */}
        <form
          className="flex flex-col w-full gap-3 mt-5 space-y-2"
          onSubmit={formik.handleSubmit}
        >
          {formik.errors.api && (
            <div className="absolute text-red-600 top-48">
              {formik.errors.api}
            </div>
          )}
